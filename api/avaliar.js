...
Agora a EVOLUÇÃO PARA O PRONTUÁRIO — é ISTO que o médico copia para o Feegow. Escreva EXATAMENTE neste formato. Use os valores informados; exame não informado, OMITA daquele grupo. NÃO repita aqui as seções de apoio, os riscos, os encaminhamentos nem o plano de contingência.
...
Conduta
Suspensão de medicações: (realista para a janela curta)
Orientações pré-operatórias (sintéticas): jejum 8h para sólidos e líquidos claros até 2h; suspensões conforme protocolo (o que couber no prazo); evitar álcool 24-48h; não aplicar minoxidil nos dias possíveis antes; vir com acompanhante adulto; não dirigir após; lavar o cabelo conforme orientação.
Orientações pós-operatórias (sintéticas): dormir com a cabeça elevada nas primeiras noites; não coçar nem traumatizar as áreas doadora/receptora; evitar sol direto, esforço físico, álcool e cigarro nos primeiros dias; lavagem conforme orientação; usar a medicação prescrita; edema e crostas são esperados e regridem; queda fisiológica dos fios e crescimento a partir de ~3-4 meses; retorno conforme agendamento.
